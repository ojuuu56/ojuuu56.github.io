      ...
      <section className="chapter-slow relative flex min-h-screen w-full items-end px-5 pb-16 sm:px-8 md:px-16 md:pb-24">
        <Card>
          ...
          <div className="reveal pt-6">
            <BookingDialog>
              <button className="pointer-events-auto inline-flex items-center gap-3 rounded-sm bg-amber-400 px-7 py-3.5 text-[0.7rem] font-semibold uppercase tracking-[0.35em] text-black shadow-[0_10px_40px_-10px_rgba(251,191,36,0.7)] transition hover:bg-amber-300">
                Book Now
              </button>
            </BookingDialog>
      ...
      <section className="chapter-slow relative flex min-h-screen w-full items-end px-5 pb-16 sm:px-8 md:px-16 md:pb-24">
        <Card>
          ...
          <div className="reveal pt-8">
            <BookingDialog>
              <button className="pointer-events-auto inline-flex items-center gap-3 rounded-sm bg-amber-400 px-8 py-4 text-[0.7rem] font-semibold uppercase tracking-[0.35em] text-black shadow-[0_10px_40px_-10px_rgba(251,191,36,0.7)] transition hover:bg-amber-300">
                Book Now
              </button>
            </BookingDialog>
